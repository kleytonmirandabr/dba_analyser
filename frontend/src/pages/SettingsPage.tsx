    ...
    <div className="max-w-lg">
      ...
      <div className="bg-surface border border-border rounded-xl p-5 mb-4">
        <div className="flex items-center gap-3 mb-4">
          <div className="w-10 h-10 bg-blue-600 rounded-full flex items-center justify-center"><User className="w-5 h-5 text-text-primary" /></div>
          <div>
      ...
      <div className="bg-surface border border-border rounded-xl p-5">
        ...
        <form onSubmit={changePassword} className="space-y-3">
          ...
          <button type="submit" disabled={saving}
            className="w-full py-2.5 bg-blue-600 hover:bg-blue-700 disabled:bg-blue-800 text-text-primary text-sm font-medium rounded-lg transition flex items-center justify-center gap-2">
